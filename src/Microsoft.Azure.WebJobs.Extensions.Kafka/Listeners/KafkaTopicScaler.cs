...
{
    internal class KafkaTopicScaler<TKey, TValue>
    {
        ...
        List<TopicPartition> LoadTopicPartitions()
        {
            try
            {
        ...
        internal void ReportLag()
        {
            ...
            {
                logger.LogInformation("Could not find the partition lag in '{topic}'", this.topic);
            }
        }
    }
}
